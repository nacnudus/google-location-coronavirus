...
country <- read_tsv("./2020-03-29-country.tsv", col_types = "ciccDciiccdidD")
...
```{r plot-us-counties-by-category, echo = FALSE, message = FALSE}
region <- read_tsv("./2020-03-29-region.tsv", col_types = "ciccDciiccdidD")
